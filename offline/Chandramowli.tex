...
\begin{document}
	...
	\hfill{\href{https://github.com/chamow97}{github.com/chamow97}}
	\vspace{1mm}
	\hrule
	\vspace{0.6mm}
	\hrule
	...
	\small
	{
	\item A browser(Chrome and Firefox) extension which keeps the user motivated with periodic motivational quotes and  videos. 
	}
	\end{itemize}	
	\vspace{3mm}
